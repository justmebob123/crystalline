...
void handle_training_tab_click(AppState* state, int x, int y) {
    ...
    // Check model selector click first (BUTTONDOWN - opens dropdown)
...
void handle_training_tab_mouse_up(AppState* state, int x, int y) {
    ...
    // Handle model selector BUTTONUP (selects item)
...
void handle_training_tab_mouse_motion(AppState* state, int x, int y) {
    ...
    // Handle model selector hover
    if (model_selector) {
        model_selector_handle_motion(model_selector, x, y);
    }
