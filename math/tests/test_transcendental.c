...
void test_trigonometric(void) {
    ...
    TEST_APPROX("Sine: sin(π/2)", math_sin(PI/2.0), 1.0);
    TEST_APPROX("Sine: sin(π)", math_sin(PI), 0.0);
    
    TEST_APPROX("Cosine: cos(0)", math_cos(0.0), 1.0);
    TEST_APPROX("Cosine: cos(π/2)", math_cos(PI/2.0), 0.0);
    TEST_APPROX("Cosine: cos(π)", math_cos(PI), -1.0);
    
    TEST_APPROX("Tangent: tan(0)", math_tan(0.0), 0.0);
    TEST_APPROX("Tangent: tan(π/4)", math_tan(PI/4.0), 1.0);
}
...
void test_inverse_trigonometric(void) {
    ...
    TEST_APPROX("Arcsine: asin(1)", math_asin(1.0), PI/2.0);
    TEST_APPROX("Arcsine: asin(-1)", math_asin(-1.0), -PI/2.0);
    
    TEST_APPROX("Arccosine: acos(1)", math_acos(1.0), 0.0);
    TEST_APPROX("Arccosine: acos(0)", math_acos(0.0), PI/2.0);
    TEST_APPROX("Arccosine: acos(-1)", math_acos(-1.0), PI);
    
    TEST_APPROX("Arctangent: atan(0)", math_atan(0.0), 0.0);
    TEST_APPROX("Arctangent: atan(1)", math_atan(1.0), PI/4.0);
    
    TEST_APPROX("Arctangent2: atan2(1, 1)", math_atan2(1.0, 1.0), PI/4.0);
    TEST_APPROX("Arctangent2: atan2(1, 0)", math_atan2(1.0, 0.0), PI/2.0);
}
